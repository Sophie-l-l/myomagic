	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { 
						boxShadow: '0 0 10px 2px rgba(0, 163, 255, 0.2), 0 0 20px 4px rgba(0, 229, 201, 0.1)' 
					},
					'50%': { 
						boxShadow: '0 0 15px 3px rgba(0, 163, 255, 0.4), 0 0 30px 6px rgba(0, 229, 201, 0.2)' 
					}
				},
				'float': {
			...
			backgroundImage: {
				...
				'sci-gradient': 'linear-gradient(135deg, #00A3FF 0%, #00E5C9 100%)'
			}
		}
	},
